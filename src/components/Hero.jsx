    ...
    <div className='grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-[1400px] md:h-[70vh] mx-auto py-8 bg-black'>
      ...
      <div className='col-span-2 px-5'>
        ...
        <p className='text-white sm:text-lg my-6 lg:text-xl'>
          My name is Shejar Kandangwa and I am a web developer with hands on experience on web field
        </p>
        <div className='my-8'>
          <a href="/shejarcv.pdf" 
  download="shejarcv.pdf"   className='px-6 py-3 w-full rounded-xl mr-4 bg-gradient-to-br from-orange-500 to-pink-500 text-white'>
            Download CV
          </a>
